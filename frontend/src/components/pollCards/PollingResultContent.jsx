...
const PollOptionVoteResult = ({label, optionVotes, totalVotes}) => {
    ...
    return (
        <div className="w-full bg-slate-200/80 rounded-md h-6 relative mb-3">
            ...
            />
            <span
                className="absolute inset-0 flex items-center justify-between text-gray-800 text-[12px] font-medium mx-3">
...
const ImagePollResult = ({imgUrl, optionVotes, totalVotes}) => {
    return (
        <div className="">
            <div className="w-full bg-gray-800 items-center gap-2 mb-4 rounded-md overflow-hidden ">
                <img
                    src={imgUrl}
                    alt="item image"
...
const OpenEndedPollResponse = ({profileImageUrl, userFullName, response, createdAt}) => (
    <div className="mb-8 ml-3">
        <div className="flex gap-3">
            ...
            <p className="text-[13px] text-black">
                {userFullName} <span className="mx-1 text-[10px] text-slate-500">•</span>
...
function PollingResultContent({type, options, voters, responses}) {
